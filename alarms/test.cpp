...
#define CLI_UPSERT_ALARM(sess, id, qualifier, resource, severity, ...) invokeAlarm(*sess, id, qualifier, resource, severity, {__VA_ARGS__});
...
TEST_CASE("1") {
	...
	auto subCtrl = std::make_shared<sysrepo::Subscription>(mngrSess->onModuleChange("ietf-alarms", [&mngrConn, &mngrSess](sysrepo::Session session, auto, auto, auto, sysrepo::Event event, auto) { return mngrUpdateControlCb(session, event, *mngrConn, *mngrSess); }, nullptr, 0, sysrepo::SubscribeOptions::DoneOnly | sysrepo::SubscribeOptions::Passive));
	auto subRpc = std::make_shared<sysrepo::Subscription>(mngrSess->onRPCAction("/sysrepo-ietf-alarms:create-or-update-alarm", [&mngrConn, &mngrSess](sysrepo::Session session, auto, auto, const libyang::DataNode input, sysrepo::Event event, auto, libyang::DataNode output) { return mngrRPC(session, event, input, output, *mngrConn, *mngrSess); }));
	...
	SUBCASE("Create a single unshelved alarm from cli1") {
		CLI_UPSERT_ALARM(cli1Sess, "czechlight-alarms:temperature-alarm", "high", "edfa", "warning");
		...
		REQUIRE(dump(*userSess, sysrepo::Datastore::Operational, "/ietf-alarms:alarms") == std::map<std::string, std::string>{
				...
				{"/ietf-alarms:alarms/alarm-list/alarm[resource='edfa'][alarm-type-id='czechlight-alarms:temperature-alarm'][alarm-type-qualifier='high']/perceived-severity", "warning"},
				});
	}

	SUBCASE("Create a single shelved alarm from cli1") {
		CLI_UPSERT_ALARM(cli1Sess, "czechlight-alarms:psu-alarm", "disconnected", "psu-1", "warning");
	...
	SUBCASE("Create one shelved and one unshelved alarm from cli1") {
		CLI_UPSERT_ALARM(cli1Sess, "czechlight-alarms:temperature-alarm", "high", "edfa", "warning");
		CLI_UPSERT_ALARM(cli1Sess, "czechlight-alarms:psu-alarm", "disconnected", "psu-1", "major");
	...
	SUBCASE("Create one unshelved alarm, shelve it and unshelve again") {
		...
		REQUIRE(dump(*userSess, sysrepo::Datastore::Operational, "/ietf-alarms:alarms") == std::map<std::string, std::string>{
				...
				{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='edfa'][alarm-type-id='czechlight-alarms:temperature-alarm'][alarm-type-qualifier='high']/perceived-severity", "warning"},
				});
	...
	SUBCASE("Create shelved alarm, then update its leafs (and move forth and forth+back)") {
		...
		CLI_UPSERT_ALARM(cli1Sess, "czechlight-alarms:psu-alarm", "disconnected", "psu-1", "warning", {"alarm-text", "text"});
		REQUIRE(dump(*userSess, sysrepo::Datastore::Operational, "/ietf-alarms:alarms") == std::map<std::string, std::string>{
				{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/alarm-type-id", "czechlight-alarms:psu-alarm"},
				{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/alarm-type-qualifier", "disconnected"},
				{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/resource", "psu-1"},
		...
		SUBCASE("Move forth") {
			...
			REQUIRE(dump(*userSess, sysrepo::Datastore::Operational, "/ietf-alarms:alarms") == std::map<std::string, std::string>{
					...
					{"/ietf-alarms:alarms/alarm-list/alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/is-cleared", "false"},
					});
		}
	...
	SUBCASE("Client sets alarm, disconnects, then connects again and clears the alarm") {
		...
		SUBCASE("Clears the alarm") {
			CLI_UPSERT_ALARM(cli1Sess, "czechlight-alarms:psu-alarm", "disconnected", "psu-1", "cleared");
			REQUIRE(dump(*userSess, sysrepo::Datastore::Operational, "/ietf-alarms:alarms") == std::map<std::string, std::string>{
					{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/alarm-type-id", "czechlight-alarms:psu-alarm"},
					{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/alarm-type-qualifier", "disconnected"},
					{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/resource", "psu-1"},
		...
		SUBCASE("Clears a non-existent alarm -> no-op") {
			CLI_UPSERT_ALARM(cli1Sess, "czechlight-alarms:temperature-alarm", "high", "edfa", "cleared");
			REQUIRE(dump(*userSess, sysrepo::Datastore::Operational, "/ietf-alarms:alarms") == std::map<std::string, std::string>{
					{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/alarm-type-id", "czechlight-alarms:psu-alarm"},
					{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/alarm-type-qualifier", "disconnected"},
					{"/ietf-alarms:alarms/shelved-alarms/shelved-alarm[resource='psu-1'][alarm-type-id='czechlight-alarms:psu-alarm'][alarm-type-qualifier='disconnected']/resource", "psu-1"},
