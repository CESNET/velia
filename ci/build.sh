...
if [[ -z "${ARTIFACT_URL}" ]]; then
    ...
    ARTIFACT_URL="https://object-store.cloud.muni.cz/swift/v1/ci-artifacts-${ZUUL_TENANT}/${ZUUL_GERRIT_HOSTNAME}/CzechLight/dependencies/${ZUUL_JOB_NAME_NO_PREFIX%%-cover?(-previous)}/${DEP_SUBMODULE_COMMIT}.tar.zst"
fi
