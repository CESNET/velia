...
std::shared_ptr<IETFHardware> create(const std::string& applianceName)
{
    ...
    if (applianceName == "czechlight-clearfog-g2") {
        ...
        ietfHardware->registerDataReader(EepromWithUid{"ne:ctrl:som:eeprom", "ne:ctrl:som", 0, 0x53});
        ...
        ietfHardware->registerDataReader(EepromWithUid{"ne:ctrl:carrier:eeprom", "ne:ctrl:carrier", 0, 0x52});
