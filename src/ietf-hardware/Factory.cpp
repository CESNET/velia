...
void createPower(std::shared_ptr<velia::ietf_hardware::IETFHardware> ietfHardware)
{
    ...
    pduGroup.registerDataReader(SysfsValue<SensorType::Temperature>("ne:pdu:temperature-1", "ne:pdu", pduHwmon, 1, Thresholds<int64_t>{
                                                                                                                       ...
                                                                                                                       .warningHigh = OneThreshold<int64_t>{40000, 2000},
                                                                                                                       .criticalHigh = OneThreshold<int64_t>{50000, 2000},
                                                                                                                   }));
...
std::shared_ptr<IETFHardware> create(const std::string& applianceName)
{
    ...
    if (applianceName == "czechlight-clearfog") {
        ...
        ietfHardware->registerDataReader(Fans("ne:fans", "ne", fans, 4, Thresholds<int64_t>{
                                                                            .criticalLow = OneThreshold<int64_t>{static_cast<int64_t>(23000 /* max rpm */ * 0.4 /* duty cycle */ * 0.4), static_cast<int64_t>(23000 * 0.4 * 0.1)},
                                                                            .warningLow = OneThreshold<int64_t>{static_cast<int64_t>(23000 * 0.4 * 0.8), static_cast<int64_t>(23000 * 0.4 * 0.1)},
