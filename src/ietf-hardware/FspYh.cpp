...
void FspYhPdu::createPower()
{
    ...
    registerReader(SysfsValue<SensorType::VoltageDC>("ne:pdu:voltage-12V",
                                                     "ne:pdu",
                                                     m_hwmon,
                                                     1,
                                                     Thresholds<int64_t>{
    ...
    registerReader(SysfsValue<SensorType::Current>("ne:pdu:current-12V", "ne:pdu", m_hwmon, 1));
    registerReader(SysfsValue<SensorType::Power>("ne:pdu:power-12V", "ne:pdu", m_hwmon, 1));
    registerReader(SysfsValue<SensorType::Temperature>("ne:pdu:temperature-1",
                                                       "ne:pdu",
                                                       m_hwmon,
                                                       1,
                                                       Thresholds<int64_t>{
    ...
    registerReader(SysfsValue<SensorType::Temperature>("ne:pdu:temperature-2",
                                                       "ne:pdu",
                                                       m_hwmon,
                                                       2,
                                                       Thresholds<int64_t>{
    ...
    registerReader(SysfsValue<SensorType::Temperature>("ne:pdu:temperature-3",
                                                       "ne:pdu",
                                                       m_hwmon,
                                                       3,
                                                       Thresholds<int64_t>{
    ...
    registerReader(SysfsValue<SensorType::VoltageDC>("ne:pdu:voltage-5V",
                                                     "ne:pdu",
                                                     m_hwmon,
                                                     2,
                                                     Thresholds<int64_t>{
    ...
    registerReader(SysfsValue<SensorType::Current>("ne:pdu:current-5V", "ne:pdu", m_hwmon, 2));
    registerReader(SysfsValue<SensorType::Power>("ne:pdu:power-5V", "ne:pdu", m_hwmon, 2));

    registerReader(SysfsValue<SensorType::VoltageDC>("ne:pdu:voltage-3V3",
                                                     "ne:pdu",
                                                     m_hwmon,
                                                     3,
                                                     Thresholds<int64_t>{
    ...
    registerReader(SysfsValue<SensorType::Current>("ne:pdu:current-3V3", "ne:pdu", m_hwmon, 3));
    registerReader(SysfsValue<SensorType::Power>("ne:pdu:power-3V3", "ne:pdu", m_hwmon, 3));
}
}
