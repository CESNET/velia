...
auto CzechLightPartialBlob = x3::rule<struct CzechLightPartialBlob, std::vector<uint8_t>>{"CzechLightPartialBlob"} =
    x3::omit[x3::byte_(0x00) >> x3::byte_(0x00) >> x3::byte_(0x1f) >> x3::byte_(0x79)] >> /* CESNET enterprise number */
    x3::omit[x3::byte_(0x00)] /* CESNET/CzechLight block version identifier */ >>
    *x3::byte_;
