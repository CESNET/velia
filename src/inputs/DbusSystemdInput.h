...
public:
    DbusSystemdInput(std::shared_ptr<AbstractManager> manager, sdbus::IConnection& connection, const std::string& bus, const std::string& managerObjPath, const std::string& managerIface, const std::string& unitIface);
