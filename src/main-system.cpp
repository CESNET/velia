...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        auto journalUploadStartup = velia::system::JournalUpload(srConn.sessionStart(sysrepo::Datastore::Startup), "/cfg/journal-remote", [](auto) {});
        auto journalUploadRunning = velia::system::JournalUpload(srConn.sessionStart(sysrepo::Datastore::Running), "/run/journal-remote", [dbusConn = g_dbusConnection.get()](auto log) {
