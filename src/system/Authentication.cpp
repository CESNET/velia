    ...
    , m_sub()
{
    ...
    sysrepo::OperGetItemsCb listUsersCb = [this] (auto session, auto, auto, auto, auto, auto, auto& out) {
    ...
    m_sub = m_session.onOperGetItems(czechlight_system_module.c_str(), listUsersCb, authentication_container.c_str());
