...
void updateSlotStatus([[maybe_unused]] std::unique_lock<std::mutex> lock, std::map<std::string, std::string>& slotStatus, std::shared_ptr<velia::system::RAUC> rauc, velia::Log log)
{
