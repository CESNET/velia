...
public:
    ...
    IETFSystem(::sysrepo::Session srSession,
               ...
               const SystemdResolvedConfig& resolved);
...
private:
    ...
    void initDNS(sdbus::IConnection& connection, const std::string& dbusName, const SystemdResolvedConfig& resolved);
