...
LED::LED(const ::sysrepo::Connection& srConn, std::filesystem::path sysfsLeds)
    ...
    , m_thrRunning(true)
{
    ...
    m_srSubscribe = m_srSession.onRPCAction(
        ...
        [this, uidMaxBrightness, triggerFile, brightnessFile](auto, auto, auto, auto input, auto, auto, auto) {
