...
void addComponent(HardwareStateDataTree& res, const std::string& compName, const HardwareStateDataTree& values)
{
...
void addSensorValueRaw(HardwareStateDataTree& res, const std::string& compName, const std::string& value)
{
...
HardwareStateDataTree Roadm::operator()() const { return m_staticData; }
...
HardwareStateDataTree Controller::operator()() const
{
    return m_staticData;
}
...
HardwareStateDataTree Fans::operator()() const
{
    HardwareStateDataTree res(m_staticData);
...
HardwareStateDataTree SysfsTemperature::operator()() const
{
    HardwareStateDataTree res(m_staticData);
...
HardwareStateDataTree EMMC::operator()() const
{
    HardwareStateDataTree res(m_staticData);
