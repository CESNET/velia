...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        auto hwmonFans = std::make_shared<velia::hardware::sysfs::HWMon>("/sys/bus/i2c/devices/1-002e/hwmon/");
        auto sysfsTempFront = std::make_shared<velia::hardware::sysfs::HWMon>("/sys/devices/platform/soc/soc:internal-regs/f1011100.i2c/i2c-1/1-002e/hwmon/");
        auto sysfsTempCpu = std::make_shared<velia::hardware::sysfs::HWMon>("/sys/devices/virtual/thermal/thermal_zone0/");
        auto sysfsTempMII0 = std::make_shared<velia::hardware::sysfs::HWMon>("/sys/devices/platform/soc/soc:internal-regs/f1072004.mdio/mdio_bus/f1072004.mdio-mii/f1072004.mdio-mii:00/hwmon/");
        auto sysfsTempMII1 = std::make_shared<velia::hardware::sysfs::HWMon>("/sys/devices/platform/soc/soc:internal-regs/f1072004.mdio/mdio_bus/f1072004.mdio-mii/f1072004.mdio-mii:01/hwmon/");
        auto emmc = std::make_shared<velia::hardware::sysfs::EMMC>("/sys/block/mmcblk0/device/");

        hwState->registerComponent(velia::hardware::component::Controller("ne:ctrl", "ne"));
        hwState->registerComponent(velia::hardware::component::Fans("ne:fans", "ne", hwmonFans, 4));
        hwState->registerComponent(velia::hardware::component::SysfsTemperature("ne:ctrl:temperature-front", "ne:ctrl", sysfsTempFront, 1));
        hwState->registerComponent(velia::hardware::component::SysfsTemperature("ne:ctrl:temperature-cpu", "ne:ctrl", sysfsTempCpu, 1));
        hwState->registerComponent(velia::hardware::component::SysfsTemperature("ne:ctrl:temperature-internal-0", "ne:ctrl", sysfsTempMII0, 1));
        hwState->registerComponent(velia::hardware::component::SysfsTemperature("ne:ctrl:temperature-internal-1", "ne:ctrl", sysfsTempMII1, 1));
        hwState->registerComponent(velia::hardware::component::EMMC("ne:ctrl:emmc", "ne:ctrl", emmc));
        ...
        subscribe->oper_get_items_subscribe("ietf-hardware-state", velia::hardware::sysrepo::OpsCallback(hwState), "/ietf-hardware-state:hardware/*");
