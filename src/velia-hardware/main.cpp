...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        hwState->registerComponent(velia::hardware::callback::Controller("ne:ctrl", "ne"));
        hwState->registerComponent(velia::hardware::callback::Fans("ne:fans", "ne", hwmonFans, 4));
        hwState->registerComponent(velia::hardware::callback::SysfsTemperature("ne:ctrl:temperature-front", "ne:ctrl", sysfsTempFront, 1));
        hwState->registerComponent(velia::hardware::callback::SysfsTemperature("ne:ctrl:temperature-cpu", "ne:ctrl", sysfsTempCpu, 1));
        hwState->registerComponent(velia::hardware::callback::SysfsTemperature("ne:ctrl:temperature-internal-0", "ne:ctrl", sysfsTempMII0, 1));
        hwState->registerComponent(velia::hardware::callback::SysfsTemperature("ne:ctrl:temperature-internal-1", "ne:ctrl", sysfsTempMII1, 1));
        hwState->registerComponent(velia::hardware::callback::EMMC("ne:ctrl:emmc", "ne:ctrl", emmc));
