...
TEST_CASE("HardwareState")
{
    ...
    struct PsuDataReader {
        ...
        velia::ietf_hardware::SensorPollData operator()()
        {
            ...
            if (active) {
                ...
                alarm = {"velia-alarms:sensor-missing", COMPONENT("ne:psu"), "warning", "PSU missing."};
            }
...

    {
        ...
        REQUIRE(sideLoadedAlarms == std::set<velia::ietf_hardware::SideLoadedAlarm>{{"velia-alarms:sensor-missing", COMPONENT("ne:psu"), "warning", "PSU missing."}});
    }
