...
TEST_CASE("HardwareState")
{
    ...
    srSubs->oper_get_items_subscribe("ietf-hardware-state", velia::ietf_hardware::sysrepo::OpsCallback(hwState), modulePrefix.c_str(), SR_SUBSCR_PASSIVE | SR_SUBSCR_OPER_MERGE | SR_SUBSCR_CTX_REUSE);
