...
#include "ietf-hardware/sysrepo/IETFHardwareSysrepo.h"
...
TEST_CASE("HardwareState")
{
    ...
    SECTION("Test HardwareState from sysrepo's view")
    {
        ...
        auto ietfHardwareSysrepo = std::make_shared<velia::ietf_hardware::sysrepo::IETFHardwareSysrepo>(srSubs, hwState);
