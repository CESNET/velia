...
public:
    MAKE_CONST_MOCK1(listUsers, std::vector<velia::system::User>(std::string_view));
    MAKE_CONST_MOCK2(changePassword, void(const std::string&, const std::string&));
    MAKE_CONST_MOCK3(addKey, void(std::string_view, const std::string&, const std::string&));
    MAKE_CONST_MOCK3(removeKey, void(std::string_view, const std::string&, const int));
};
