...
struct AlarmInventory {
    ...
    void add(const std::string& alarmTypeId, const std::string& alarmTypeQualifier, const std::optional<std::string>& resource, const std::optional<std::string>& severity);
...
#define ALARM_INVENTORY_INSERT(INV, ALARM_TYPE, ALARM_QUALIFIER, RESOURCE, SEVERITY) LR_SIDE_EFFECT(INV.add(ALARM_TYPE, ALARM_QUALIFIER, RESOURCE, SEVERITY))
