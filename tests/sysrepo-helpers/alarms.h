...
#define REQUIRE_ALARM_IN_ALARM_INVENTORY(INV, ALARM_TYPE, ALARM_QUALIFIER, RESOURCE) LR_WITH(INV.contains(ALARM_TYPE, ALARM_QUALIFIER, RESOURCE))

// inserts the alarm in AlarmInventory as a side effect
#define INSERT_INTO_ALARM_INVENTORY(INV, ALARM_TYPE, ALARM_QUALIFIER, RESOURCE) LR_SIDE_EFFECT(INV.add(ALARM_TYPE, ALARM_QUALIFIER, RESOURCE))
...
#define REQUIRE_NEW_ALARM_INVENTORY_ENTRY(WATCHER, ALARM_TYPE, ALARM_QUALIFIER, RESOURCE)                                                                                                              \
    REQUIRE_DATASTORE_CHANGE(WATCHER.datastoreWatcher,                                                                                                                                                 \
        ...
        .INSERT_INTO_ALARM_INVENTORY(WATCHER.alarmInventory, ALARM_TYPE, ALARM_QUALIFIER, RESOURCE)
...
#define REQUIRE_NEW_ALARM(WATCHER, ALARM_TYPE, ALARM_QUALIFIER, RESOURCE, SEVERITY, TEXT)                                           \
    REQUIRE_RPC_CALL(WATCHER.rpcWatcher, (Values{                                                                                   \
        ...
        .REQUIRE_ALARM_IN_ALARM_INVENTORY(WATCHER.alarmInventory, ALARM_TYPE, ALARM_QUALIFIER, RESOURCE)
