...
TEST_CASE("IETF Hardware with sysrepo")
{
    ...
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
        ...
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-low-value-alarm'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:psu:child']"},
                                         }))
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-high-value-alarm'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:psu:child']"},
                                         }))
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-missing-alarm'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:psu:child']"},
                                         }))
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-low-value-alarm'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:temperature-cpu']"},
                                         }))
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-high-value-alarm'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:temperature-cpu']"},
                                         }))
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-missing-alarm'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:temperature-cpu']"},
                                         }))
        .IN_SEQUENCE(seq1);
    ...
    REQUIRE_CALL(alarmEvents, event(std::map<std::string, std::string>{
                                  ...
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/alarm-text", "Sensor value not reported. Maybe the sensor was unplugged?"},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/alarm-type-id", "velia-alarms:sensor-missing-alarm"},
    ...
    REQUIRE_CALL(alarmEvents, event(std::map<std::string, std::string>{
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm", "(unprintable)"},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/alarm-text", "Sensor value crossed high threshold."},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/alarm-type-id", "velia-alarms:sensor-high-value-alarm"},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/alarm-type-qualifier", ""},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/resource", "/ietf-hardware:hardware/component[name='ne:psu:child']"},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/severity", "warning"},
                              }))
    ...
    REQUIRE_CALL(alarmEvents, event(std::map<std::string, std::string>{
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm", "(unprintable)"},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/alarm-text", "Sensor value crossed low threshold."},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/alarm-type-id", "velia-alarms:sensor-low-value-alarm"},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/alarm-type-qualifier", ""},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/resource", "/ietf-hardware:hardware/component[name='ne:power']"},
                                  {"/sysrepo-ietf-alarms:create-or-update-alarm/severity", "critical"},
                              }))
