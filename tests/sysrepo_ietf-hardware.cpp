...
TEST_CASE("IETF Hardware with sysrepo")
{
    ...
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             ...
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-reading-out-of-range'][alarm-type-qualifier='']", "(list instance)"},
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-reading-out-of-range'][alarm-type-qualifier='']/alarm-type-id", "velia-alarms:sensor-reading-out-of-range"},
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-reading-out-of-range'][alarm-type-qualifier='']/alarm-type-qualifier", ""},
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-reading-out-of-range'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:power']"},
                                         }))
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
        ...
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-reading-out-of-range'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:psu:child']"},
                                         }))
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
        ...
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
                                             {"/ietf-alarms:alarms/alarm-inventory/alarm-type[alarm-type-id='velia-alarms:sensor-reading-out-of-range'][alarm-type-qualifier='']/resource[1]", "/ietf-hardware:hardware/component[name='ne:temperature-cpu']"},
                                         }))
        .IN_SEQUENCE(seq1);
    REQUIRE_CALL(dsChangeAlarmInventory, change(std::map<std::string, std::variant<std::string, Deleted>>{
