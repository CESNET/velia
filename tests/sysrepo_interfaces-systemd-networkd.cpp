...
Gateway=2001:db8::2
        ...
        client.setItem(yangV4RoutePrefix + "/route[destination-prefix='10.9.8.0/24']/next-hop/next-hop-address"s, "10.9.8.1");
...
Gateway=10.9.8.1
        ...
        client.setItem(yangV6RoutePrefix + "/route[destination-prefix='2001:db8:abcd:1234::/64']/next-hop/outgoing-interface"s, "eth1");
