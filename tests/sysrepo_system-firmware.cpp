...
TEST_CASE("Firmware in czechlight-system, RPC")
{
    ...
    REQUIRE(dataFromSysrepo(client, "/czechlight-system:firmware", sysrepo::Datastore::Operational) == std::map<std::string, std::string> {
                ...
                {"/firmware-slot[name='A']/installed", "2021-01-13T18:15:50+01:00"},
                ...
                {"/firmware-slot[name='B']/installed", "2021-01-13T18:20:15+01:00"},
...
TEST_CASE("Firmware in czechlight-system, slot status")
{
    ...
    SECTION("Complete data")
    {
        ...
        expected = {
            ...
            {"[name='A']/installed", "2021-01-13T18:15:50+01:00"},
            {"[name='A']/name", "A"},
            {"[name='A']/state", "inactive"},
            {"[name='A']/version", "v4-104-ge80fcd4"},
            {"[name='B']/boot-status", "good"},
            {"[name='B']/installed", "2021-01-13T18:20:15+01:00"},
            {"[name='B']/name", "B"},
            {"[name='B']/state", "booted"},
