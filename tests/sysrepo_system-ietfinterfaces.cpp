...
EmitLLDP=nearest-bridge
        ...
        client->set_item_str("/ietf-interfaces:interfaces/interface[name='br0']/ietf-ip:ipv4/ietf-ip:enabled", "true");
        ...
        client->set_item_str("/ietf-interfaces:interfaces/interface[name='eth1']/ietf-ip:ipv4/enabled", "false");
