...
struct SystemctlMock {
    ...
    MAKE_CONST_MOCK0(reloadResolve, void());
};
...
TEST_CASE("Sysrepo ietf-system")
{
    ...
    SECTION("Test system-state")
    {
        ...
        SECTION("Valid data")
        {
            ...
            REQUIRE_CALL(systemctlMock, reloadResolve()).IN_SEQUENCE(seq1);
    ...
    SECTION("DNS resolvers")
    {
        ...
        {
            SECTION("No DNS servers")
            {
                REQUIRE(velia::utils::readFileToString(*resolve.dropinDir / "resolved.conf") == R"(# Autogenerated by velia. Do not edit.
[Resolve]
DNS=
)");
                // fallback servers
...
DNS=8.8.8.8:53 8.8.8.8:123 [2606:4700:4700::1111]:53 [2606:4700:4700::1111]:123
                ...
                dbusServer.setDNSEx({
                    {0, AF_INET, {8, 8, 8, 8}, 0, "czech.light"},
                    {0, AF_INET, {8, 8, 8, 8}, 123, "czech.light"},
                    {2, AF_INET6, {0x26, 0x06, 0x47, 0x00, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x11}, 0, "czech.light"},
                    {2, AF_INET6, {0x26, 0x06, 0x47, 0x00, 0x47, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x11, 0x11}, 123, "czech.light"},
                });
                ...
                expected = {
                    ...
                    {"/server[name='2']/name", "2"},
                    {"/server[name='2']/udp-and-tcp", ""},
                    {"/server[name='2']/udp-and-tcp/address", "8.8.8.8"},
                    {"/server[name='2']/udp-and-tcp/port", "123"},
                    {"/server[name='3']", ""},
                    {"/server[name='3']/name", "3"},
                    {"/server[name='3']/udp-and-tcp", ""},
                    {"/server[name='3']/udp-and-tcp/address", "2606:4700:4700::1111"},
                    {"/server[name='4']", ""},
                    {"/server[name='4']/name", "4"},
                    {"/server[name='4']/udp-and-tcp", ""},
                    {"/server[name='4']/udp-and-tcp/address", "2606:4700:4700::1111"},
                    {"/server[name='4']/udp-and-tcp/port", "123"},
                };
            }
        }
    ...
    SECTION("NTP")
    {
        ...
        SECTION("NTP enabled with servers")
        {
            ...
            REQUIRE(dataFromSysrepo(client, "/ietf-system:system/ntp", sysrepo::Datastore::Operational) == (std::map<std::string, std::string>{
                        {"/enabled", "true"},
                        ...
                        {"/server[name='02-system']/prefer", "true"},
                        {"/server[name='03-link']", ""},
