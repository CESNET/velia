...
int main(int argc, char* argv[])
{
    ...
    bool isDaemonSubscribe = strcmp(argv[1], "--subscribe") == 0;
    bool isDaemonSetItem = strcmp(argv[1], "--set-item") == 0;
    ...
    std::shared_ptr<sysrepo::Subscribe> srSubs = nullptr; // for subscribe
    uint32_t srLastRequestId = 0; // for subscribe
